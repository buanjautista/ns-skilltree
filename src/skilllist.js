export const skillList = [{name: "Immortal Dash", cost: 0, img: '', description: "Press [DASH] while moving on the ground to dash forward and evade enemy attacks. Also effective for evading Crimson Attacks and lasers."},
